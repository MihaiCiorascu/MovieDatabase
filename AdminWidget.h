...
public:
    ...
    QPushButton *addMovieButton, *deleteMovieButton, *updateMovieButton, *displayPlotButton, *undoButton, *redoButton;
    ...
    QHBoxLayout *createUndoRedoButtons();
